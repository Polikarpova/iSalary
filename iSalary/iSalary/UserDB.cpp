...
void UserDB::createTable() {
    ...
    query.prepare(
        "CREATE TABLE IF NOT EXISTS `users` (`id` int(11) NOT NULL AUTO_INCREMENT,`login` varchar(50) CHARACTER SET utf8 NOT NULL,`password` varchar(50) "
        "CHARACTER SET utf8 NOT NULL,`type` int(11) NOT NULL,`firstName` varchar(100) CHARACTER SET utf8 DEFAULT NULL,`secondName` varchar(100) CHARACTER SET "
        "utf8 DEFAULT NULL,`thirdName` varchar(100) CHARACTER SET utf8 DEFAULT NULL,`sex` int(11) DEFAULT NULL,`passportSource` varchar(100) CHARACTER SET "
        "utf8 DEFAULT NULL,`passportSerial` varchar(6) CHARACTER SET utf8 DEFAULT NULL,`passportNumber` varchar(8) CHARACTER SET utf8 DEFAULT "
        "NULL,`passportIssueDate` date DEFAULT NULL,`address` varchar(100) CHARACTER SET utf8 DEFAULT NULL,`INN` varchar(40) CHARACTER SET utf8 DEFAULT "
        "NULL,`email` varchar(100) CHARACTER SET utf8 DEFAULT NULL,`mobileNumber` varchar(100) CHARACTER SET utf8 DEFAULT NULL,`dateOfEmployment` date DEFAULT "
        "NULL,`dateOfBirth` date DEFAULT NULL,PRIMARY KEY (`id`))" );
...
User UserDB::insert( const User &user, UserType type ) {
    ...
    sql = sql.arg( this->tableName, this->loginField, this->passwordField, this->userTypeField );
    query.prepare( sql );
...
void UserDB::update( const User &user ) {
    ...
    sql = sql.arg( this->tableName, this->loginField, this->passwordField, this->idField );
    query.prepare( sql );
...
UserInfo UserDB::getById( int id ) {
    ...
    sql = sql.arg( this->tableName, this->idField, this->loginField, this->passwordField, this->userTypeField );
