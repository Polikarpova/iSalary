...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SalesPage_t, stringdata0) + ofs \
...
void SalesPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SalesPage *_t = static_cast<SalesPage *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject SalesPage::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SalesPage.data,
      qt_meta_data_SalesPage,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SalesPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SalesPage.stringdata0))
        return static_cast<void*>(const_cast< SalesPage*>(this));
