...
SalesPage::SalesPage( SalesFacade *salesFacade ) { this->salesFacade = salesFacade; }
...
void SalesPage::setErrorHandler( ErrorMessageHandler *errorHandler ) { this->errorHandler = errorHandler; }

void SalesPage::setUI( QTabWidget *tabWidget, QPushButton *salesForAllButton, QTableView *managersSalesTable, QTableView *unconfirmedSalesTable,
...
void SalesPage::setEnable( bool flag ) { this->tabWidget->setEnabled( flag ); }
