...
ProductPage::ProductPage( ProductFacade *productFacade ) { this->productFacade = productFacade; }

ProductPage::~ProductPage() {}

void ProductPage::setUI( QWidget *tabWidget, QLineEdit *productSearchInput, QTableView *productTable, QLineEdit *productNameInput,
                         QDoubleSpinBox *productPercentInput, QStackedWidget *productButtonsStackedWidget, QPushButton *addProductButton,
                         QPushButton *deleteProductButton, QPushButton *editProductButton, QPushButton *cancelProductButton, QPushButton *saveProductButton,
                         QPushButton *productCancelAddButton, QPushButton *productSubmitAddButton ) {
    ...
    connect( this->productTable->selectionModel(), SIGNAL( currentChanged( const QModelIndex &, const QModelIndex & ) ), this,
             SLOT( enableEditAndRemoveButtons() ) );
...
void ProductPage::setErrorHandler( ErrorMessageHandler *errorHandler ) { this->errorHandler = errorHandler; }

void ProductPage::setWindow( QWidget *widget ) { this->widget = widget; }

void ProductPage::startBlockForRequest() { this->tabWidget->setEnabled( false ); }

void ProductPage::endBlockForRequest() { this->tabWidget->setEnabled( true ); }
...
void ProductPage::enableEditAndRemoveButtons() { setEnabledEditAndRemoveButtons( true ); }
