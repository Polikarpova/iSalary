...
TabNavigator::TabNavigator( QTabWidget *tabs ) { this->tabs = tabs; }

TabNavigator::~TabNavigator( void ) {}

void TabNavigator::setEmployeesPage( EmployeesPage *employeesPage ) { this->employeesPage = employeesPage; }

void TabNavigator::setProductPage( ProductPage *productPage ) { this->productPage = productPage; }

void TabNavigator::setSalesPage( SalesPage *salesPage ) { this->salesPage = salesPage; }
