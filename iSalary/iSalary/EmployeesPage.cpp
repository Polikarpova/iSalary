...
EmployeesPage::EmployeesPage( PersonnalAccountingFacade *pa ) { this->personnalAccouting = pa; }

EmployeesPage::~EmployeesPage( void ) {}

void EmployeesPage::setUI( QWidget *tabWidget, QTableView *managersTable, QLineEdit *loginInput, QLineEdit *passwordInput, QLineEdit *firstNameInput,
                           QLineEdit *secondNameInput, QLineEdit *thirdNameInput, QDateTimeEdit *birthdayInput, QSpinBox *passportSerialInput,
                           QSpinBox *passportNumberInput, QGroupBox *sexChecKGroup, QRadioButton *maleInput, QRadioButton *femaleInput,
                           QLineEdit *passportSourceInput, QDateTimeEdit *passportIssueDate, QLineEdit *addressInput, QLineEdit *INNInput,
                           QStackedWidget *buttonStackedWidget, QPushButton *editBtn, QPushButton *addBtn, QPushButton *confirmUpdateBtn,
                           QPushButton *cancelUpdateBtn, QPushButton *confirmAddBtn, QPushButton *cancelAddBtn, QLabel *dataHeader ) {
...
void EmployeesPage::setErrorHandler( ErrorMessageHandler *errorHandler ) { this->errorHandler = errorHandler; }
...
void EmployeesPage::showDetails( const QModelIndex &index ) { this->showDetailsById( this->getSelectedManagerId() ); }
...
ManagerDTO EmployeesPage::readFromInputs() {
    ...
    if ( manager.passportNumber.size() < passportNumberSize ) {
        manager.passportNumber = QString( passportNumberSize - manager.passportNumber.size(), '0' ) + manager.passportNumber;
    }
    ...
    if ( manager.passportSerial.size() < passportSerialSize ) {
        manager.passportSerial = QString( passportSerialSize - manager.passportSerial.size(), '0' ) + manager.passportSerial;
    }
...
void EmployeesPage::inputError( QWidget *edit ) { edit->setStyleSheet( "border: 1px solid red" ); }

void EmployeesPage::clearError( QWidget *edit ) { edit->setStyleSheet( this->widgetDefaultStyles[edit] ); }
...
void EmployeesPage::startBlockForRequest() { this->tabWidget->setEnabled( false ); }

void EmployeesPage::endBlockForRequest() { this->tabWidget->setEnabled( true ); }